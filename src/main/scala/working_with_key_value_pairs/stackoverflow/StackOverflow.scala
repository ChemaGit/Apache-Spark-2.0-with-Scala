package working_with_key_value_pairs.stackoverflow
...
object StackOverflow extends StackOverflow {
  ...
  private[stackoverflow] def filePath = {
    val resource = this.getClass.getClassLoader.getResource("working_with_key_value_pairs/stackoverflow/resources/stackoverflow.csv")
